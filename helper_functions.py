...
def extract_csv_from_excel():
    ...
    excel_file_path = './lab6-data/tfl-data/tfl-daily-cycle-hires.xlsx'
    ...
    data_df.to_csv('tfl-daily-cycle-hires.csv', index=False)


def load_tfl_cycle_data():
    cycle_df = pd.read_csv('./tfl-daily-cycle-hires.csv').iloc[:, :2]
